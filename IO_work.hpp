...
public:
    ...
    LocationsMap read_map(std::istream& in_stream);
...
public:
    std::map<size_t, std::vector<std::string>> getUserTrack(const LocationsMap& map, const UserLog& user, const int& user_id);
